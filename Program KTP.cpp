...
{
    data ktp[20];
    int menu,nik=-1,i,j,pilih,namedit;
    char get[1];
    bool ketemu;
    ...
    system ("color 37");
    gotoxy(32,1);
	cout<<"Nama : Elsa Diana Putri \n";
	gotoxy(32,2);
	cout<<"NIM  :              20170801161                 \n\n";
	gotoxy(32,4);
    cout<<"-------------Program Data KTP C++ -------------";
    cout <<" \nMENU  :\n\n";
    garis();
    ...
    if(menu==1)
 {
     ...
     cout<<"\n Penambahan Data KTP\n";
     garis();
     cout<<" NIK (maximal 5 karakter)        : "; cin>>ktp[nik].nomor; cin.getline(get,1); cout<< endl;
     ...
     cout<<" Tanggal Lahir(Tgl/Bulan/Tahun)  : "; cin.getline(ktp[nik].tanggal,20);cout<< endl;
     cout<<" Alamat                          : "; cin.getline(ktp[nik].almt,20);cout<< endl;
     cout<<" Kelurahan                       : "; cin.getline(ktp[nik].alamat.kel,20);cout<< endl;
     ...
     else if(pilih==2)
  {
  	  system("cls");
  	  gotoxy(32,12);
  	  cout<<"Terimakasih Telah mencoba Program Data KTP kami"<<endl;
     }
    }
    ...
    else if(menu==2)
 {
     ...
     for(i=0;i<=nik;i++)
  {
      if(namedit==ktp[i].nomor)
   {
       ...
       cout<<" Nama Lengkap      : "<<ktp[i].nama<<endl;cout<<endl;
                cout<<" Agama             : "<<ktp[i].agama<<endl;cout<<endl;
                cout<<" Status perkawinan : "<<ktp[i].status<<endl;cout<<endl;
                cout<<" Pekerjaan         : "<<ktp[i].pekerjaan<<endl;cout<<endl;
                cout<<" Tempat Lahir      : "<<ktp[i].tempat<<endl;cout<<endl;
                cout<<" Tanggal Lahir     : "<<ktp[i].tanggal<<endl;cout<<endl;
                cout<<" Alamat            : "<<ktp[i].almt<<endl; cout<<endl;
                cout<<" Kelurahan         : "<<ktp[i].alamat.kel<<endl;cout<<endl;
                cout<<" Kecamatan         : "<<ktp[i].alamat.kec<<endl;cout<<endl;
 ...
 else if(menu==3)
 {
  system ("cls");
  garis();
  cout<<"\n PENGHAPUSAN DATA PADA DATA KTP\n";
  garis();
  ...
  cout<<" ____________________________________________\n\n";
     ...
     cout<<" 2.Keluar dari program\n";
      garis();
        cout<<" Masukan Pilihannya : "; cin>>pilih;
        if(pilih==1)
  {
  	  system("cls");
      goto menuutama;
